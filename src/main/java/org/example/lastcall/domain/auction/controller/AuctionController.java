...
public class AuctionController {
	...
	public ResponseEntity<ApiResponse<AuctionResponse>> createAuction(
		...
		return ResponseEntity.status(HttpStatus.CREATED).body(ApiResponse.success("경매가 등록되었습니다.", response));
	}
	...
	public ResponseEntity<ApiResponse<PageResponse<AuctionReadAllResponse>>> getAllAuctions(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("경매가 전체 조회되었습니다.", pageResponse));
	}
	...
	public ResponseEntity<ApiResponse<AuctionReadResponse>> getAuction(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("해당 경매가 조회되었습니다.", response));
	}
	...
	public ResponseEntity<ApiResponse<PageResponse<MySellingResponse>>> getMySellingAuctions(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내가 판매한 경매 목록이 조회되었습니다.", pageResponse));
	}
	...
	public ResponseEntity<ApiResponse<MySellingResponse>> getMySellingDetailAuctions(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내가 판매한 경매 중 해당 경매가 조회되었습니다.", response));
	}
	...
	public ResponseEntity<ApiResponse<PageResponse<MyParticipatedResponse>>> getMyParticipatedAuctions(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내가 참여한 경매 목록이 조회되었습니다.", pageResponse));
	}
	...
	public ResponseEntity<ApiResponse<MyParticipatedResponse>> getMyParticipatedDetailAuction(
		@AuthenticationPrincipal AuthUser authUser,
		@PathVariable Long auctionId) {
		MyParticipatedResponse response = auctionQueryService.getMyParticipatedDetailAuction(authUser.userId(), auctionId);

		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내가 참여한 경매 중 해당 경매가 조회되었습니다.", response));
	}
	...
	public ResponseEntity<ApiResponse<AuctionResponse>> updateAuction(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내 경매가 수정되었습니다.", response));
	}
	...
	public ResponseEntity<ApiResponse<Void>> deleteAuction(
		...
		return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("내 경매가 삭제되었습니다."));
	}
}

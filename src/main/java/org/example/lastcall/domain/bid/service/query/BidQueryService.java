...
public class BidQueryService implements BidQueryServiceApi {
    ...
    @Override
    public Optional<Bid> getTopByAuctionOrderByBidAmountDesc(Auction auction) {
        return bidRepository.findTopByAuctionOrderByBidAmountDesc(auction);
    }

    @Override
    public Optional<Bid> getLastBidExceptBidId(Long auctionId, Long userId, Long currentBidId) {

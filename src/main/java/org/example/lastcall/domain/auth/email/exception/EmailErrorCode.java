...
public enum EmailErrorCode implements ErrorCode {
    ...
    EMAIL_VERIFICATION_NOT_FOUND(HttpStatus.BAD_REQUEST, "이메일 인증을 먼저 요청해주세요."),
    ...
    INVALID_VERIFICATION_ID(HttpStatus.BAD_REQUEST, "이메일 인증 식별자가 유효하지 않습니다."),
    INVALID_UUID_FORMAT(HttpStatus.BAD_REQUEST, "요청한 UUID 형식이 올바르지 않습니다.");

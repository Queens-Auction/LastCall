...
//     @Test
//     void createAuction_동시에_요청_시_중복_등록이_방지된다() throws InterruptedException {
//         // given
//         // 테스트용 판매자 유저 생성
...
//     }
//
//     @DisplayName("동시 종료 요청 - 입찰이 없으면 유찰(CLOSED_FAILED) 상태로 한 번만 처리됨")
//     @Test
//     void closeAuction_동시_요청_시_입찰이_없으면_유찰_상태로_한_번만_처리된다() throws InterruptedException {
//         //given
//         // 테스트용 판매자 유저 생성
...
//     }
//
//     @DisplayName("동시 종료 요청 - 입찰이 존재하면 낙찰 처리는 한 번만 수행되고 중복 종료는 발생하지 않음")
//     @Test
//     void closeAuction_동시_요청_시_입찰이_존재하면_낙찰_처리는_한_번만_수행된다() throws InterruptedException {
//         //given
//         // 테스트용 판매자 유저 생성

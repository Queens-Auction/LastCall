...
public class MyParticipatedResponse {
	...
	private MyParticipatedResponse(Long id, String imageUrl, String productName, String productDescription, Long currentBid,
								   AuctionStatus status, LocalDateTime startTime, LocalDateTime endTime, Long myBidAmount, Boolean isLeading) {
		this.id = id;
	...
	public static MyParticipatedResponse fromDetail(Auction auction, Product product, String imageUrl,
														     Long currentBid, Long myBidAmount, Boolean isLeading) {
		return new MyParticipatedResponse(
			auction.getId(),
			imageUrl,
			product.getName(),
